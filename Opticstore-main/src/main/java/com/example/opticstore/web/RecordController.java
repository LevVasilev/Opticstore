package com.example.opticstore.web;

import com.example.opticstore.model.Record;
import com.example.opticstore.model.User;
import com.example.opticstore.repository.UserRepository;
import com.example.opticstore.service.RecordService;
...
public class RecordController {
    ...
    public String addRecord(@ModelAttribute("record") RecordDto recordDto) {
        ...
        record.setUser(user);
        record.setProduct(recordDto.getProduct());
        record.setCount(recordDto.getCount());
        record.setPriceforone(recordDto.getPriceforone());
